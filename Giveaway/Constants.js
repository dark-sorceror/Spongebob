 ...
 * @property {string|MessageObject} [winMessage='Congratulations, {winners}! You won **{this.prize}**!'] Sent in the channel when the giveaway is ended. "{winners}" will be replaced automatically with the mentions of the giveaway winners.
 ...
 * @property {string} [noWinner='No one!'] Displayed in the giveaway embed when there is no valid winner for the giveaway.
